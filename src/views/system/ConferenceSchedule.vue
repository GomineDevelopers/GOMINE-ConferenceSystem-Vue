<template>
  <div class="ConferenceSchedule height_auto position_re">
    <vue-headful title="会务日程"></vue-headful>
    <div class="ms_content height_calc">
      <div class="block fontSize0">
        <div class="ms_title inlineBlock_verTop">会务时间：</div>
        <el-date-picker
          v-model="time.value1"
          type="daterange"
          range-separator="至"
...
<style >
.ConferenceSchedule .picker_input .el-date-editor.el-input,
.ConferenceSchedule .picker_input .el-date-editor.el-input__inner {
  width: 145px;
  margin-right: 20px;
}
.ConferenceSchedule .text_input .el-input {
  width: 200px;
  margin-right: 20px;
}
</style>
...
.ConferenceSchedule .perFont {
  font-size: 16px;
  margin-bottom: 15px;
  line-height: 60px;
}
.ConferenceSchedule .ms_title {
  width: 80px;
  height: 40px;
  font-size: 14px;
...
.ConferenceSchedule .content_font {
  height: 20px;
  font-size: 14px;
  font-family: PingFangTC;
  line-height: 20px;
...
.ConferenceSchedule .content_font2 {
  margin-left: 20px;
}
.ConferenceSchedule .AddAndSubstract_p2 {
  /* padding-top: 5px; */
}

/* *************** 自适应相关 */
.ConferenceSchedule .media_manage1 {
  display: none;
}
.ConferenceSchedule .media_manage2 {
  display: none;
}
